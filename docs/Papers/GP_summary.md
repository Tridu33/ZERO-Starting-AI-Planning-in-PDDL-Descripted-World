...
Jimenez, S., Segovia-Aguas, J., & Jonsson, A. (2019). **综述** A review of Generalized planning. *The Knowledge Engineering Review, 34.*
...
Bonet, B., & Geffner, H. (2018). Features, projections, and representation change for **Generalized planning**. In *Proceedings of the 27th International Joint Conference on Artificial Intelligence,* pp. 4667-4673. AAAI Press.将 GP 映射至 QNP 求解
...
Fikes, R., & Nilsson, N. (1971). STRIPS: A new approach to the application of theorem proving to problem solving. *Artificial Intelligence,* 1, 27-120.**STRIPS 规划语言的紧凑描述**——规划语言

Geffner, T., & Geffner, H. (2018). Compact policies for fully observable non-deterministic planning as sat. In *Proc. ICAPS.*将 FOND 问题转换为 SAT 问题求解（对应论文及 GitHub 源码程序包）
...
Geffner, H., & Bonet, B. (2013). **A *Concise Introduction** to Models and Methods for Automated Planning.* Morgan & Claypool Publishers.聚焦 FOND 问题

Ghallab, M., Nau, D., & Traverso, P. (2016). *Automated planning and acting.* CambridgeUniversity Press.

## 2.2. QNP

Srivastava, S., Zilberstein, S., Immerman, N., & Geffner, H. (2011). Qualitative numeric planning. In AAAI.该文章详细阐述了 FOND 问题的解对应着 QNP 问题的解（并非互推关系），并介绍了 SCC 算法等内容（学长已报告过）

Srivastava, S., Immerman, N., & Zilberstein, S. (2011). A new representation and associated algorithms for **Generalized planning**. *Artificial Intelligence, 175*(2), 615-647.提出了利用 QNP 有效表述 GP（通用规划）的方法
...
Boutilier, C., Reiter, R., & Price, B. (2001). Symbolic dynamic programming for first-order MDPs. In *Proc. IJCAI,* Vol. 1, pp. 690-700.一阶马尔可夫过程的动态规划（由此可见，**MDP** 的马尔可夫数学化研究过程能够自然地与 **RL** 强化学习相衔接）
...
Wang, C., Joshi, S., & Khardon, R. (2008). First order decision diagrams for relational MDPs. *Journal of Artificial Intelligence Research, 31,* 431-472.一阶决策图对应求解 MDP
...
Littman, M. L., Goldsmith, J., & Mundhenk, M. (1998). The computational complexity of probabilistic planning. *Journal of Artificial Intelligence Research, 9,* 1-36.表明 QNP 问题具有指数级别的计算复杂度
...
Cimatti, A., Roveri, M., & Traverso, P. (1998). Automatic **OBDD-based** 一种广为采用的紧凑表达结构 generation of universal plans in non-deterministic domains. In *Proc. AAAI-98,* pp. 875-881.
